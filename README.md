# BoardList - 
## Talenvo Global Residency (Frontend Development Track) Week 2 Project
### Architecture, Engineering Decisions, and Performance Strategy

A production-grade collaborative knowledge board. BoardList lets teams organise ideas, tasks, and documentation across multiple boards, columns, and cards - with real-time multi-user collaboration, threaded comments, basic markdown (bold and italics) support and undo/redo support.
